package transition
{
	...
	public class TransitionAtoB extends Sprite
	{
		...
		public function TransitionAtoB()
		{
			super();
		...
		private function init():void{
			gameBG = new Loader();
			gameBG.load(new URLRequest("image/scene/C_FullShip.jpg"));
		...
		private function close(e:Event):void{
			...
			dispatchEvent(new Event(TransitionBtoC.PAGE_CLOSE));
		}
