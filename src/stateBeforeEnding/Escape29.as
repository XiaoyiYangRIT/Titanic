package stateBeforeEnding
{
	...
	public class Escape29 extends Sprite
	{
		...
		private function setDialog():void{
			speaking = new Typewriter('ec29',0, gameBG.height * 0.8, gameBG.width, gameBG.height * 0.8);
			speaking.x = 0;
		...
		private function close():void{
			...
			dispatchEvent(new Event(Escape29.PAGE_CLOSE));
