package stateBeforeEnding
{
	...
	public class DieinLaundryRoom extends Sprite
	{
		...
		public function DieinLaundryRoom()
		{
			super();
			init();
		}
		private function init():void{
			gameBG = new Loader();
			gameBG.load(new URLRequest("image/scene/the-secret-of-margrave-manor-2-lost-ship004.jpg"));
		...
		private function setDialog():void{
			speaking = new Typewriter('dlr',0, gameBG.height * 0.8, gameBG.width, gameBG.height * 0.8);
			speaking.x = 0;
