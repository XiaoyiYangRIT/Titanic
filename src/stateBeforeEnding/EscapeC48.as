package stateBeforeEnding
{
	...
	public class EscapeC48 extends Sprite
	{
		...
		private function setDialog():void{
			speaking = new Typewriter('ec48',0, gameBG.height * 0.8, gameBG.width, gameBG.height * 0.2);
			speaking.x = 0;
		...
		private function close():void{
			...
			dispatchEvent(new Event(EscapeC48.PAGE_CLOSE));
