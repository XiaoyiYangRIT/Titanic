package stateBeforeEnding
{
	...
	public class DieC49 extends Sprite
	{
		...
		private function setDialog():void{
			speaking = new Typewriter('dc49',0, gameBG.height * 0.8, gameBG.width, gameBG.height * 0.8);
			speaking.x = 0;
		...
		private function close():void{
			...
			dispatchEvent(new Event(DieC49.PAGE_CLOSE));
