package stateBeforeEnding
{
	...
	public class EscapeC43 extends Sprite
	{
		...
		private function setDialog():void{
			speaking = new Typewriter('ec43',0, gameBG.height * 0.8, gameBG.width, gameBG.height * 0.8);
			speaking.x = 0;
		...
		private function close():void{
			...
			dispatchEvent(new Event(EscapeC43.PAGE_CLOSE));
