package stateBeforeEnding
{
	...
	public class DieC52 extends Sprite
	{
		...
		private function setDialog():void{
			speaking = new Typewriter('dc52',0, gameBG.height * 0.8, gameBG.width, gameBG.height * 0.8);
			speaking.x = 0;
		...
		private function close():void{
			...
			dispatchEvent(new Event(DieC52.PAGE_CLOSE));
