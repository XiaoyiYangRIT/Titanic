package stateBeforeEnding
{
	...
	public class EscapeC50 extends Sprite
	{
		...
		private function setDialog():void{
			speaking = new Typewriter('ec50',0, gameBG.height * 0.8, gameBG.width, gameBG.height * 0.8);
			speaking.x = 0;
		...
		private function close():void{
			...
			dispatchEvent(new Event(EscapeC50.PAGE_CLOSE));
