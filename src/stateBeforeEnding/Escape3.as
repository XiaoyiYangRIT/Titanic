package stateBeforeEnding
{
	...
	public class Escape3 extends Sprite
	{
		...
		private function setDialog():void{
			speaking = new Typewriter('ec3',0, gameBG.height * 0.8, gameBG.width, gameBG.height * 0.8);
			speaking.x = 0;
		...
		private function close():void{
			...
			dispatchEvent(new Event(Escape3.PAGE_CLOSE));
