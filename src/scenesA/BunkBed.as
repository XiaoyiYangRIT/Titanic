package scenesA
{
	...
	public class BunkBed extends Sprite
	{
		...
		private function init():void{
			gameBG = new Loader();
			gameBG.load(new URLRequest("image/scene/A_BunkBed.jpg"));
		...
		private function close(e:Event):void{
			...
			dispatchEvent(new Event(BunkBed.PAGE_CLOSE));
		}
