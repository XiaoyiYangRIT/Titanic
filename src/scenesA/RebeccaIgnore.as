package scenesA
{
	...
	public class RebeccaIgnore extends Sprite
	{
		...
		private function init():void{
			gameBG = new Loader();
			gameBG.load(new URLRequest("image/scene/A_B_Rebecca_Ignore.jpg"));
		...
		private function close(e:Event):void{
			...
			dispatchEvent(new Event(RebeccaIgnore.PAGE_CLOSE));
		}
