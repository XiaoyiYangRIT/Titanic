package scenesA
{
	...
	public class Opt1Out extends Sprite
	{
		...
		private function init():void{
			gameBG = new Loader();
			gameBG.load(new URLRequest("image/scene/A_Opt1_Out.jpg"));
		...
		private function close(e:Event):void{
			...
			dispatchEvent(new Event(Opt1Out.PAGE_CLOSE));
		}
