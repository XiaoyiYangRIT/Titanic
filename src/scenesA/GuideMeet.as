package scenesA
{
	...
	public class GuideMeet extends Sprite
	{
		...
		private function init():void{
			gameBG = new Loader();
			gameBG.load(new URLRequest("image/scene/C_GuideMeet.jpg"));
		...
		private function close(e:Event):void{
			...
			dispatchEvent(new Event(GuideMeet.PAGE_CLOSE));
		}
