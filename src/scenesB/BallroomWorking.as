package scenesB
{
	...
	public class BallroomWorking extends Sprite
	{
		...
		public function BallroomWorking()
		{
			super();
			init();
		}
		...
		private function setGBG(e:Event):void{
			...
			speaking = new Dialogue('brw', 0, gameBG.height, gameBG.width, gameBG.height * 0.2);
			addChild(speaking);
		...
		private function close():void{
			...
			dispatchEvent(new Event(BallroomWorking.PAGE_CLOSE));
