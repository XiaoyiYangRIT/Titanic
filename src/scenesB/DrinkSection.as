package scenesB
{
	...
	public class DrinkSection extends Sprite
	{
		...
		private function init():void{
			gameBG = new Loader();
			gameBG.load(new URLRequest("image/scene/MissParker_Bar.jpg"));
		...
		private function setGBG(e:Event):void{
			...
			switch(outV){
				case 1:
					speaking = new Dialogue('ds', 0, gameBG.height, gameBG.width, gameBG.height * 0.2);
					addChild(speaking);
					break;
				case 2:
					speaking = new Dialogue('ds2', 0, gameBG.height, gameBG.width, gameBG.height * 0.2);
					addChild(speaking);
					break;
				default:
		...
		private function close():void{
			...
			dispatchEvent(new Event(DrinkSection.PAGE_CLOSE));
