package endings
{
	...
	public class BadEndingDisappear extends Sprite
	{
		...
		public function BadEndingDisappear()
		{
			super();
			init();
		}
		...
		private function setDialog():void{
			speaking = new Typewriter('finalending1',0, gameBG.height * 0.8, gameBG.width, gameBG.height);
			speaking.x = 0;
