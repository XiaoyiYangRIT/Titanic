package scenesC
{
	...
	public class HallwayC extends Sprite
	{
		...
		private function init():void{
			gameBG = new Loader();
			gameBG.load(new URLRequest("image/scene/First-Class-Hallway-The-Henry-Ford-Titanic-The-Artifact-Exhibition.jpg"));
		...
		private function setDialog():void{
			diashift = true;
			diadown = false;
			speaking = new Dialogue('hwc', 0, gameBG.height, gameBG.width, gameBG.height * 0.2);
			addChild(speaking);
		...
		private function close():void{
			...
			dispatchEvent(new Event(HallwayC.PAGE_CLOSE));
