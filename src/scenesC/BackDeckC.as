package scenesC
{
	...
	public class BackDeckC extends Sprite
	{
		...
		private function setDialog():void{
			diashift = true;
			diadown = false;
			speaking = new Dialogue('bdc', 0, gameBG.height, gameBG.width, gameBG.height * 0.2);
			addChild(speaking);
