package scenesC
{
	...
	public class JumpinWater extends Sprite
	{
		...
		private function setDialog():void{
			diashift = true;
			diadown = false;
			speaking = new Dialogue('jw', 0, gameBG.height, gameBG.width, gameBG.height * 0.2);
			addChild(speaking);
		...
		private function close():void{
			...
			dispatchEvent(new Event(JumpinWater.PAGE_CLOSE));
