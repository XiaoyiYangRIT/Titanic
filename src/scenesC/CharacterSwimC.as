package scenesC
{
	...
	public class CharacterSwimC extends Sprite
	{
		...
		public function CharacterSwimC()
		{
			super();
			init();
		}
		...
		private function setDialog():void{
			diashift = true;
			diadown = false;
			speaking = new Dialogue('csc', 0, gameBG.height, gameBG.width, gameBG.height * 0.2);
			addChild(speaking);
		...
		private function close():void{
			...
			dispatchEvent(new Event(CharacterSwimC.PAGE_CLOSE));
