package scenesC
{
	...
	public class PreHelpGerman extends Sprite
	{
		...
		private function setDialog():void{
			...
			if(preS){
				speaking = new Dialogue('phgpr', 0, gameBG.height, gameBG.width, gameBG.height * 0.2);
			}else{
				speaking = new Dialogue('phgd', 0, gameBG.height, gameBG.width, gameBG.height * 0.2);
			}
			addChild(speaking);
		...
		private function close():void{
			...
			dispatchEvent(new Event(PreHelpGerman.PAGE_CLOSE));
